...
type C11LandingPageColumnexplorebycategoOneProps = Omit<
...
> &
  Partial<{
    explorebycategorytext: JSX.Element | string;
    showalljobstext: string;
    designtext: string;
    jobsavailabletext: string;
    salestext: string;
    jobsavailabletext1: string;
    marketingtext: string;
    jobsavailabletext2: string;
    financetext: string;
    jobsavailabletext3: string;
    technologytext: string;
    jobsavailabletext4: string;
    engineeringtext: string;
    jobsavailabletext5: string;
    businesstext: string;
    jobsavailabletext6: string;
    humanresourcetext: string;
    jobsavailabletext7: string;
  }>;

const C11LandingPageColumnexplorebycategoOne: React.FC<
  C11LandingPageColumnexplorebycategoOneProps
> = (props) => {
  return (
    <>
