...
type C11LandingPageColumnfeaturedjobsProps = Omit<
...
> &
  Partial<{
    featuredjobs: JSX.Element | string;
    showalljobsOne: string;
    fullTime: string;
    emailmarketing: string;
    revolut: string;
    country: string;
    revolutislookinOne: string;
    marketing: string;
    design: string;
    fulltime1: string;
    ...
    revolut1: string;
    madridspain: string;
    revolutislookin: string;
    design1: string;
    business: string;
    fulltime2: string;
    emailmarketing2: string;
    revolut2: string;
    country1: string;
    revolutislookin1: string;
    marketing1: string;
    fulltime3: string;
    emailmarketing3: string;
    revolut3: string;
    country2: string;
    revolutislookin2: string;
    design2: string;
    fulltime4: string;
    emailmarketing4: string;
    revolut4: string;
    madridspain1: string;
    revolutislookin3: string;
    marketing2: string;
    design3: string;
    fulltime5: string;
    emailmarketing5: string;
    revolut5: string;
    country3: string;
    revolutislookin4: string;
    design4: string;
    business1: string;
    fulltime6: string;
    emailmarketing6: string;
    revolut6: string;
    country4: string;
    revolutislookin5: string;
    marketing3: string;
    fulltime7: string;
    emailmarketing7: string;
    revolut7: string;
    madridspain2: string;
    revolutislookin6: string;
    technology: string;
  }>;

const C11LandingPageColumnfeaturedjobs: React.FC<
  C11LandingPageColumnfeaturedjobsProps
> = (props) => {
  return (
    <>
...
C11LandingPageColumnfeaturedjobs.defaultProps = {
  featuredjobs: (
    ...
    >
      <span className="text-gray-50 font-clashdisplayvariable text-left font-semibold">
        Featured
      </span>
