...
type C11LandingPageHeader1desktopProps = Omit<
...
> &
  Partial<{
    pic: string;
    discovermoretext: JSX.Element | string;
    platformtext: string;
    jobtitletext: string;
    searchbutton: string;
    populartext: JSX.Element | string;
    jobhuntlytext: string;
    jobhuntlytext1: string;
    caption: string;
...
const C11LandingPageHeader1desktop: React.FC<
  C11LandingPageHeader1desktopProps
> = (props) => {
  return (
    <>
        ...
        <div className="absolute bottom-[13%] flex flex-col gap-[23px] items-start justify-start left-[9%] max-w-[852px] w-full">
          ...
          <div className="flex flex-col gap-4 items-start justify-start w-auto md:w-full">
            <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-center max-w-[852px] p-4 shadow-bs w-full">
              ...
              <Button
                className="!text-white-A700 cursor-pointer font-bold font-epilogue h-[57px] text-center text-lg w-[209px]"
                shape="square"
                color="indigo_A700"
                size="2xl"
                variant="fill"
