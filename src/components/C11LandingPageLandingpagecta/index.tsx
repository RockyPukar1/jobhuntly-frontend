...
type C11LandingPageLandingpagectaProps = Omit<
  ...
  | "applicantscounttext"
  | "applicantstext"
  | "applicantsstatistictext"
  | "viewalljobsbutton"
  | "applicantscountertext"
  | "socialmediaspecialisttext"
  | "seniorengineertext"
  | "applicantscounter"
  | "seniorengineertext1"
  | "applicantscounter1"
...
> &
  Partial<{
    ...
    sattext: string;
    suntext: string;
    applicantscounttext: string;
    applicantstext: string;
    applicantsstatistictext: string;
    viewalljobsbutton: string;
    applicantscountertext: string;
    socialmediaspecialisttext: string;
    seniorengineertext: string;
    applicantscounter: string;
    seniorengineertext1: string;
    applicantscounter1: string;
    othertext: string;
    applicantscounter2: string;
    recentapplicantOne: string;
    jakegyll: string;
    email: string;
    dateapplied: string;
    captionThree: string;
    ...
    settingstext: string;
    settingsonetext: string;
    helptext: string;
    jobhuntlytext: string;
  }>;

const C11LandingPageLandingpagecta: React.FC<
  C11LandingPageLandingpagectaProps
> = (props) => {
  return (
    <>
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
            <div className="flex flex-col gap-6 items-start justify-start md:mt-0 mt-[23px] w-auto">
              ...
              <Text
                ...
                size="txtEpilogueMedium16WhiteA700"
              >
                {props?.pricetext}
              </Text>
              <Button
                  ...
                  <div className="flex flex-col gap-2 justify-start w-full">
                    <div className="flex flex-row gap-1.5 items-start justify-end md:ml-[0] ml-[360px] w-[19%] md:w-full">
                      <Button
                        ...
                        variant="fill"
                      >
                        <div className="!text-white-A700 font-bold font-epilogue text-base text-center">
                          {props?.postjobbutton}
                        </div>
                      </Button>
                      ...
                      <div className="bg-gray-50 flex flex-row gap-[14.88px] items-center justify-between p-[9.4px] w-full">
                        ...
                        <div className="h-2 px-[8.22px] py-[4.7px] relative w-[60px]">
                          ...
                          <Text
                            ...
                            size="txtEpilogueBold14IndigoA700"
                          >
                            {props?.captionThree}
                          </Text>
                        </div>
