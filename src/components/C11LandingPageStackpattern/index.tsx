...
type C11LandingPageStackpatternProps = Omit<
  ...
  | "marketingone1"
  | "designone1"
  | "socialmediaassithree1"
  | "nomadtwo1"
  | "countryone1"
  | "fulltimetwo1"
  | "marketingtwo1"
  | "designtwo1"
  | "socialmediaassifour1"
  | "nomadthree1"
  | "countrytwo1"
  | "fulltimethree1"
  | "marketingthree1"
...
> &
  Partial<{
    jobdata: string;
    latestjobsopen: JSX.Element | string;
    ...
    marketing: string;
    design: string;
    socialmediaassiTwo: string;
    nomadOne: string;
    parisfrance: string;
    fullTimeOne: string;
    marketingOne: string;
    designOne: string;
    socialmediaassiThree: string;
    nomadTwo: string;
    countryOne: string;
    fullTimeTwo: string;
    marketingTwo: string;
    designTwo: string;
    socialmediaassiFour: string;
    nomadThree: string;
    countryTwo: string;
    fullTimeThree: string;
    marketingThree: string;
    designThree: string;
    ...
    marketing1: string;
    design1: string;
    socialmediaassitwo1: string;
    nomadone1: string;
    parisfrance1: string;
    fulltimeone1: string;
    marketingone1: string;
    designone1: string;
    socialmediaassithree1: string;
    nomadtwo1: string;
    countryone1: string;
    fulltimetwo1: string;
    marketingtwo1: string;
    designtwo1: string;
    socialmediaassifour1: string;
    nomadthree1: string;
    countrytwo1: string;
    fulltimethree1: string;
    marketingthree1: string;
    designthree1: string;
  }>;

const C11LandingPageStackpattern: React.FC<C11LandingPageStackpatternProps> = (
  props,
) => {
  return (
    <>
