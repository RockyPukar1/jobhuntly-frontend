...
type C12FindJobsHeader2desktopProps = Omit<
...
> &
  Partial<{
    ...
    jobhuntlyOne: string;
    caption: string;
    rectangle2740: string;
    captionOne: string;
    captionTwo: string;
    signUp: string;
    findyour: string;
    dreamjob: string;
    findyournextcarOne: string;
    jobtitleorkeywoOne: string;
    search: string;
    popularuidesignOne: string;
  }>;
...
const C12FindJobsHeader2desktop: React.FC<C12FindJobsHeader2desktopProps> = (
  props,
) => {
  return (
    <>
          ...
          <div className="flex flex-col gap-10 items-center justify-start w-auto md:w-full">
            ...
            <div className="flex flex-col gap-4 items-start justify-start w-auto md:w-full">
              <div className="bg-white-A700 flex md:flex-col flex-row gap-5 items-start justify-start max-w-[1192px] p-6 sm:px-5 shadow-bs w-full">
                ...
                <Button
                  className="!text-white-A700 cursor-pointer font-bold font-epilogue text-base text-center w-[113px]"
                  shape="square"
                  color="indigo_A700"
                  size="xl"
                  variant="fill"
