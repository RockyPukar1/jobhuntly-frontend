...
type C12FindJobsLandingpagejobProps = Omit<
...
> &
  Partial<{
    ...
    interactivedevelopertext: string;
    terraformtext: string;
    hamburggermanytext: string;
    fulltimebutton2: string;
    marketingbutton2: string;
    designbutton2: string;
    apply2: string;
    p5appliedoften2: JSX.Element | string;
    leadengineertext: string;
    canvatext: string;
    ankaraturkeytext: string;
...
const C12FindJobsLandingpagejob: React.FC<C12FindJobsLandingpagejobProps> = (
  props,
) => {
  return (
    <>
