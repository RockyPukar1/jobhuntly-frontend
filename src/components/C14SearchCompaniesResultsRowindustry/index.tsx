...
type C14SearchCompaniesResultsRowindustryProps = Omit<
...
> &
  Partial<{
    ...
    p7jobs6: string;
    komodo6: string;
    komodoisanopen4: string;
    business6: string;
    p7jobs7: string;
    komodo7: string;
    komodoisanopen5: string;
    business7: string;
    blockchain3: string;
    one: string;
    two: string;
...
const C14SearchCompaniesResultsRowindustry: React.FC<
  C14SearchCompaniesResultsRowindustryProps
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <div className="flex flex-col gap-8 items-center justify-start w-auto md:w-full">
          ...
          <div className="flex flex-row items-start justify-center w-[32%] md:w-full">
            ...
            <Button
              className="!text-white-A700 cursor-pointer font-inter font-semibold min-w-[42px] ml-[26px] rounded text-base text-center"
              color="indigo_A700"
              size="md"
              variant="fill"
            >
