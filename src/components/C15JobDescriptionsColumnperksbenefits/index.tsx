...
type C15JobDescriptionsColumnperksbenefitsProps = Omit<
...
> &
  Partial<{
    ...
    benefitdescription3: JSX.Element | string;
    benefittitle4: string;
    benefitdescription4: string;
    benefittitle5: string;
    benefitdescription5: string;
    benefittitle6: string;
    benefitdescription6: string;
    benefittitle7: string;
    benefitdescription7: string;
  }>;

const C15JobDescriptionsColumnperksbenefits: React.FC<
  C15JobDescriptionsColumnperksbenefitsProps
> = (props) => {
  return (
    <>
