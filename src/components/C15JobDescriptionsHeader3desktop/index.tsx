...
type C15JobDescriptionsHeader3desktopProps = Omit<
...
> &
  Partial<{
    ...
    jobhuntlyonetext: string;
    captiontext: string;
    captiononetext: string;
    captiontwotext: string;
    signupbutton: string;
    homecompaniestext: string;
...
const C15JobDescriptionsHeader3desktop: React.FC<
  C15JobDescriptionsHeader3desktopProps
> = (props) => {
  return (
    <>
      <div className={props.className}>
        <header className="bg-white-A700 flex md:flex-col md:gap-10 items-center justify-between md:px-10 sm:px-5 px-[124px] w-full">
          ...
          <div className="flex flex-row gap-4 h-[78px] md:h-auto items-center justify-center w-auto">
            ...
            <Button
              className="!text-white-A700 cursor-pointer font-bold font-epilogue min-w-[108px] text-base text-center"
              shape="square"
              color="indigo_A700"
              size="xl"
              variant="fill"
        ...
        <div className="flex flex-col gap-[45px] items-start justify-start w-[83%] md:w-full">
          ...
          <div className="bg-white-A700 border border-gray-300 border-solid flex md:flex-col flex-row md:gap-10 items-center justify-between max-w-[1187px] p-6 sm:px-5 w-full">
            ...
            <div className="flex flex-row gap-[30px] items-center justify-center w-auto">
              ...
              <Button
                className="!text-white-A700 cursor-pointer font-bold font-epilogue min-w-[164px] text-center text-lg"
                shape="square"
                color="indigo_A700"
                size="2xl"
                variant="fill"
