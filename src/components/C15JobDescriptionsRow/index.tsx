...
type C15JobDescriptionsRowProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "stripetext" | "buttontext" | "descriptiontwo"
> &
  Partial<{ stripetext: string; buttontext: string; descriptiontwo: string }>;

const C15JobDescriptionsRow: React.FC<C15JobDescriptionsRowProps> = (props) => {
  return (
    <>
