...
type C15JobDescriptionsRowdescriptionProps = Omit<
...
> &
  Partial<{
    ...
    communityengagetext: string;
    focusonsocial: string;
    marketingandstrOne: string;
    stayontopoftrenOne: string;
    engagewithonlinOne: string;
    whoyouaretext: string;
    yougetenergyfromtext: string;
    youhaveasensetext: string;
    youareaconfidenttext: string;
    youredetailorientedtext: JSX.Element | string;
    youreagrowthtext: JSX.Element | string;
    nicetohaves: string;
    languagetext: string;
    projectmanagementtext: string;
    copyeditingtext: string;
    ...
    projectmanagementbutton: string;
    copywritingbutton: string;
    socialmediamarketingbutton: string;
    englishbutton: string;
    copyeditingbutton: string;
  }>;

const C15JobDescriptionsRowdescription: React.FC<
  C15JobDescriptionsRowdescriptionProps
> = (props) => {
  return (
    <>
