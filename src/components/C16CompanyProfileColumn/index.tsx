...
type C16CompanyProfileColumnProps = Omit<
...
> &
  Partial<{
    teamtitle: string;
    seeallfortyseven: string;
    clestingardinie: string;
    ceocofounder: string;
    language: string;
    ceocofounder1: string;
    clestingardinie1: string;
    ceocofounder2: string;
    clestingardinie2: string;
    ceocofounder3: string;
    clestingardinie3: string;
    ceocofounder4: string;
  }>;

const C16CompanyProfileColumn: React.FC<C16CompanyProfileColumnProps> = (
  props,
) => {
  return (
    <>
