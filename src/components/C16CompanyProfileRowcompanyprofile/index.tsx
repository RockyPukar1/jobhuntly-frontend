...
type C16CompanyProfileRowcompanyprofileProps = Omit<
...
const C16CompanyProfileRowcompanyprofile: React.FC<
  C16CompanyProfileRowcompanyprofileProps
> = (props) => {
  return (
    <>
...
C16CompanyProfileRowcompanyprofile.defaultProps = {
  ...
  stripeofficesspOne: "Stripe offices spread across 20 countries",
  unitedstates: "United States",
  england: "England",
  country: "Japan",
  countryOne: "Australia",
  countryTwo: "China",
