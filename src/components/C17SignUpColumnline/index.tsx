...
type C17SignUpColumnlineProps = Omit<
...
> &
  Partial<{
    ...
    confirmation: string;
    login: string;
    byclickingcontiOne: JSX.Element | string;
  }>;

const C17SignUpColumnline: React.FC<C17SignUpColumnlineProps> = (props) => {
  return (
    <>
...
C17SignUpColumnline.defaultProps = {
...
export default C17SignUpColumnline;
