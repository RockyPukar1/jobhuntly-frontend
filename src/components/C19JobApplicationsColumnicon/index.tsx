...
type C19JobApplicationsColumniconProps = Omit<
...
> &
  Partial<{
    ...
    p0500: string;
    attachyourresumOne: string;
    attachresumebutton: string;
    submitbutton: string;
    bysendingthereqOne: JSX.Element | string;
  }>;

const C19JobApplicationsColumnicon: React.FC<
  C19JobApplicationsColumniconProps
> = (props) => {
  return (
    <>
...
C19JobApplicationsColumnicon.defaultProps = {
  ...
  attachresumebutton: "Attach Resume/CV",
