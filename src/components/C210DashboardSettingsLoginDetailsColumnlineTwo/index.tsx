...
type C210DashboardSettingsLoginDetailsColumnlineTwoProps = Omit<
...
> &
  Partial<{
    ...
    thisislogininfoOne: string;
    updateemail: string;
    updateyouremailOne: string;
    email: string;
    youremailaddresOne: string;
    label: string;
    updateEmail: string;
    newpassword: string;
    manageyourpasswOne: string;
    labelOne: string;
    thisishelpertex: string;
    labelTwo: string;
    thisishelpertexOne: string;
    closeaccount: string;
  }>;

const C210DashboardSettingsLoginDetailsColumnlineTwo: React.FC<
  C210DashboardSettingsLoginDetailsColumnlineTwoProps
> = (props) => {
  return (
    <>
