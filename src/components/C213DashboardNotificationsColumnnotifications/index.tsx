...
type C213DashboardNotificationsColumnnotificationsProps = Omit<
...
> &
  Partial<{
    ...
    janmayerinvitedOne: JSX.Element | string;
    new: string;
    timeFour: string;
    janaaliciafrom: JSX.Element | string;
    shortlisted: string;
    durationOne: string;
    allywalesfrom: JSX.Element | string;
    interviewjake: string;
    socialmediamanaOne: string;
    date: string;
    mon20july2021: string;
    time: string;
    timeOne: string;
    jakegyllOne: string;
    email: string;
...
const C213DashboardNotificationsColumnnotifications: React.FC<
  C213DashboardNotificationsColumnnotificationsProps
> = (props) => {
  return (
    <>
