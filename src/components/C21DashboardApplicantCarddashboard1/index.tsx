...
type C21DashboardApplicantCarddashboard1Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "interviewedtext" | "eighteentext"
> &
  Partial<{ interviewedtext: string; eighteentext: string }>;

const C21DashboardApplicantCarddashboard1: React.FC<
  C21DashboardApplicantCarddashboard1Props
> = (props) => {
  return (
    <>
