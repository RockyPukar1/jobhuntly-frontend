...
type C21DashboardApplicantCarddashboard2Props = Omit<
...
> &
  Partial<{
    jobsappliedstatOne: string;
    sixty: string;
    unsuitable: string;
    forty: string;
    interviewed: string;
    viewallapplicatOne: string;
  }>;

const C21DashboardApplicantCarddashboard2: React.FC<
  C21DashboardApplicantCarddashboard2Props
> = (props) => {
  return (
    <>
