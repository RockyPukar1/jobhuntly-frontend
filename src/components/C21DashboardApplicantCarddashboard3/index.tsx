...
type C21DashboardApplicantCarddashboard3Props = Omit<
...
> &
  Partial<{
    ...
    timeThree: string;
    sectiontitle: string;
    datetext: JSX.Element | string;
  }>;

const C21DashboardApplicantCarddashboard3: React.FC<
  C21DashboardApplicantCarddashboard3Props
> = (props) => {
  return (
    <>
