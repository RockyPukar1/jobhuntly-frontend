...
type C21DashboardApplicantColumnrecentapplicatiOneProps = Omit<
  ...
  | "date2"
  | "declined"
  | "viewallapplicatThree"
> &
  Partial<{
    recentapplicatiOne: string;
    ...
    date2: string;
    declined: string;
    viewallapplicatThree: string;
  }>;

const C21DashboardApplicantColumnrecentapplicatiOne: React.FC<
  C21DashboardApplicantColumnrecentapplicatiOneProps
> = (props) => {
  return (
    <>
