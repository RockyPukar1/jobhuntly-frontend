...
type C21DashboardApplicantRowgoodmorningjakeOneProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "greetingtext" | "jobapplicationstext" | "datetext" | "calendaricon"
> &
  Partial<{
    greetingtext: string;
    jobapplicationstext: string;
    datetext: string;
    calendaricon: string;
  }>;

const C21DashboardApplicantRowgoodmorningjakeOne: React.FC<
  C21DashboardApplicantRowgoodmorningjakeOneProps
> = (props) => {
  return (
    <>
