...
type C21DashboardApplicantTopnavProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "dashboardtext" | "backtohomepagebutton"
> &
  Partial<{ dashboardtext: string; backtohomepagebutton: string }>;

const C21DashboardApplicantTopnav: React.FC<
  C21DashboardApplicantTopnavProps
> = (props) => {
  return (
    <>
