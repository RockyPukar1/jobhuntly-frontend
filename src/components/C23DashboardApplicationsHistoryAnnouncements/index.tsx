...
type C23DashboardApplicationsHistoryAnnouncementsProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "newfeaturetext" | "descriptiontext"
> &
  Partial<{ newfeaturetext: string; descriptiontext: string }>;

const C23DashboardApplicationsHistoryAnnouncements: React.FC<
  C23DashboardApplicationsHistoryAnnouncementsProps
> = (props) => {
  return (
    <>
