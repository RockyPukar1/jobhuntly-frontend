...
type C23DashboardApplicationsHistoryColumnapplicationshisOneProps = Omit<
...
> &
  Partial<{
    ...
    oneTwo: string;
    nomadTwo: string;
    socialmediaassiFive: string;
    dateTwo: string;
    offered: string;
    oneThree: string;
    nomadThree: string;
    socialmediaassiSeven: string;
    dateThree: string;
    interviewing: string;
    oneFour: string;
    nomadFour: string;
    socialmediaassiNine: string;
    dateFour: string;
    unsuitable: string;
    oneFive: string;
    oneSix: string;
...
const C23DashboardApplicationsHistoryColumnapplicationshisOne: React.FC<
  C23DashboardApplicationsHistoryColumnapplicationshisOneProps
> = (props) => {
