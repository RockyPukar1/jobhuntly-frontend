...
type C24DashboardFindJobsListSearchboxProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "jobtitleorkeyword" | "searchbutton" | "popularuidesignOne"
> &
  Partial<{
    jobtitleorkeyword: string;
    searchbutton: string;
...
const C24DashboardFindJobsListSearchbox: React.FC<
  C24DashboardFindJobsListSearchboxProps
> = (props) => {
  return (
    <>
