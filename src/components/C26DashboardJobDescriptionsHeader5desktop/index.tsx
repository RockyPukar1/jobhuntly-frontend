...
type C26DashboardJobDescriptionsHeader5desktopProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "socialmediaassiOne" | "nomad" | "country" | "fulltime" | "apply"
> &
  Partial<{
...
const C26DashboardJobDescriptionsHeader5desktop: React.FC<
  C26DashboardJobDescriptionsHeader5desktopProps
> = (props) => {
  return (
    <>
