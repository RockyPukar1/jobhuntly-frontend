...
type C26DashboardJobDescriptionsRowdescriptionProps = Omit<
  ...
  | "focusonsocialtext"
  | "marketingandstrategytext"
  | "stayontopoftrendstext"
  | "engagewithonlinecommunitiestext"
  | "whoyouaretext"
  ...
  | "nicetohavestext"
  | "fluentinenglishtext"
  | "projectmanagementskillstext"
  | "copyeditingskillstext"
  | "aboutthisroletext"
  | "p5appliedoften"
  | "applybefore"
  | "applybeforetext"
...
> &
  Partial<{
    ...
    communityengagementtext: string;
    focusonsocialtext: string;
    marketingandstrategytext: string;
    stayontopoftrendstext: string;
    engagewithonlinecommunitiestext: string;
    whoyouaretext: string;
    yougetenergyfrompeopletext: string;
    youhaveasenseforbeautifulspacestext: string;
    youareaconfidentofficemanagertext: string;
    youaredetailorientedandcreativetext: JSX.Element | string;
    youareagrowthmarketertext: JSX.Element | string;
    nicetohavestext: string;
    fluentinenglishtext: string;
    projectmanagementskillstext: string;
    copyeditingskillstext: string;
...
const C26DashboardJobDescriptionsRowdescription: React.FC<
  C26DashboardJobDescriptionsRowdescriptionProps
> = (props) => {
  return (
    <>
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                ...
                <div className="flex flex-row gap-2 items-start justify-start w-auto md:w-full">
                  ...
                  <Text
                    ...
                    size="txtEpilogueRegular16Bluegray700"
                  >
                    {props?.marketingandstrategytext}
                  </Text>
                </div>
