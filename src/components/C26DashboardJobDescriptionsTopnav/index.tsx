...
type C26DashboardJobDescriptionsTopnavProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "jobdescriptiontext" | "backtohomepagetext"
> &
  Partial<{ jobdescriptiontext: string; backtohomepagetext: string }>;

const C26DashboardJobDescriptionsTopnav: React.FC<
  C26DashboardJobDescriptionsTopnavProps
> = (props) => {
  return (
    <>
