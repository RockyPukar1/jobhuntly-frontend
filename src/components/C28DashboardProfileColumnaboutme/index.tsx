...
type C28DashboardProfileColumnaboutmeProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "aboutme" | "descriptiontext" | "experiencetext"
> &
  Partial<{ aboutme: string; descriptiontext: string; experiencetext: string }>;

const C28DashboardProfileColumnaboutme: React.FC<
  C28DashboardProfileColumnaboutmeProps
> = (props) => {
  return (
    <>
