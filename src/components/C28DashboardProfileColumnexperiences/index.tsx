...
type C28DashboardProfileColumnexperiencesProps = Omit<
...
> &
  Partial<{
    experiences: string;
    productdesignerOne: string;
    twitter: string;
    fulltime: string;
    jun2019present: string;
    manchesteruk: string;
    description: string;
    productdesigner: string;
    twitter1: string;
    fulltime1: string;
    jun2019present1: string;
    manchesteruk1: string;
    description1: string;
    show3moreexperione: string;
  }>;

const C28DashboardProfileColumnexperiences: React.FC<
  C28DashboardProfileColumnexperiencesProps
> = (props) => {
  return (
    <>
