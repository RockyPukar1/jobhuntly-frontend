...
type C28DashboardProfileColumnportfoliosProps = Omit<
...
> &
  Partial<{
    portfolios: string;
    clinicallyclinione: string;
    growthlysaas: string;
    plannaproject: string;
    funirolanding: string;
  }>;

const C28DashboardProfileColumnportfolios: React.FC<
  C28DashboardProfileColumnportfoliosProps
> = (props) => {
  return (
    <>
