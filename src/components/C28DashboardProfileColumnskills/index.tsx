...
type C28DashboardProfileColumnskillsProps = Omit<
...
> &
  Partial<{
    ...
    dynamicproperty5: string;
    dynamicproperty6: string;
    dynamicproperty7: string;
  }>;

const C28DashboardProfileColumnskills: React.FC<
  C28DashboardProfileColumnskillsProps
> = (props) => {
  return (
    <>
