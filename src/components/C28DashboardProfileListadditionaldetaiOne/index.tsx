...
type C28DashboardProfileListadditionaldetaiOneProps = Omit<
...
const C28DashboardProfileListadditionaldetaiOne: React.FC<
  C28DashboardProfileListadditionaldetaiOneProps
> = (props) => {
  return (
    <>
