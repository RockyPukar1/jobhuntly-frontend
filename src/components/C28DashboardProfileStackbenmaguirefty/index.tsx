...
type C28DashboardProfileStackbenmaguireftyProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "nametext" | "designationtext" | "editprofilebutton"
> &
  Partial<{
    nametext: string;
    designationtext: JSX.Element | string;
    editprofilebutton: string;
  }>;

const C28DashboardProfileStackbenmaguirefty: React.FC<
  C28DashboardProfileStackbenmaguireftyProps
> = (props) => {
  return (
    <>
