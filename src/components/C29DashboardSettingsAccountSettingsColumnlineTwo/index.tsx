...
type C29DashboardSettingsAccountSettingsColumnlineTwoProps = Omit<
...
> &
  Partial<{
    ...
    thisisyourpersoOne: string;
    profilephototext: string;
    profilephotodescription: string;
    clicktoreplacetext: JSX.Element | string;
    imageformattext: string;
    personaldetailstext: string;
    label: JSX.Element | string;
    labelOne: JSX.Element | string;
    labelTwo: JSX.Element | string;
    labelThree: JSX.Element | string;
    labelFour: JSX.Element | string;
    accounttypetext: string;
    accounttypedescription: string;
    jobseekertext: string;
    lookingforajobtext: string;
    employertext: string;
    hiringsourcingtext: string;
    saveprofilebutton: string;
  }>;

const C29DashboardSettingsAccountSettingsColumnlineTwo: React.FC<
  C29DashboardSettingsAccountSettingsColumnlineTwoProps
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <Line className="bg-gray-300 h-px w-full" />
        <Button
          className="!text-white-A700 cursor-pointer font-bold font-epilogue min-w-[145px] text-base text-center"
          shape="square"
          color="indigo_A700"
          size="xl"
          variant="fill"
