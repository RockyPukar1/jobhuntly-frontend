...
type C310DashboardCompanyApplicantsTableViewColumnfullnameProps = Omit<
...
> &
  Partial<{
    ...
    inReview: string;
    p13july2021: string;
    seeApplication: string;
    jakegyllOne: string;
    fortyOne: string;
    inReviewOne: string;
    p13july2021one: string;
    seeApplicationOne: string;
    jakegyllTwo: string;
    fortyTwo: string;
    shortlisted: string;
    p13july2021two: string;
    seeApplicationTwo: string;
    jakegyllThree: string;
    fortyThree: string;
    declined: string;
    p13july2021three: string;
    seeApplicationThree: string;
    jakegyllFour: string;
    fortyFour: string;
    hired: string;
    p13july2021four: string;
    seeApplicationFour: string;
    jakegyllFive: string;
    fortyFive: string;
    hiredOne: string;
    p13july2021five: string;
    seeApplicationFive: string;
    jakegyllSix: string;
    fortySix: string;
    interview: string;
    p13july2021six: string;
    seeApplicationSix: string;
    jakegyllSeven: string;
    fortySeven: string;
    declinedOne: string;
    p13july2021seven: string;
    seeApplicationSeven: string;
    jakegyllEight: string;
    fortyEight: string;
    shortlistedOne: string;
    p13july2021eight: string;
    seeApplicationEight: string;
    jakegyllNine: string;
    fortyNine: string;
    interviewOne: string;
    p13july2021nine: string;
    seeApplicationNine: string;
    viewTwo: string;
...
type Table5RowType = {
  ...
  rowfullname: string;
  rowscore: string;
  rowhiringstage: string;
  rowapplieddate: string;
  rowaction: string;
};

const C310DashboardCompanyApplicantsTableViewColumnfullname: React.FC<
  C310DashboardCompanyApplicantsTableViewColumnfullnameProps
> = (props) => {
