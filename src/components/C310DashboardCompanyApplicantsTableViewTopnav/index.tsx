...
type C310DashboardCompanyApplicantsTableViewTopnavProps = Omit<
...
> &
  Partial<{
    ...
    designtext: string;
    fulltimetext: string;
    hiredtext: JSX.Element | string;
    moreactiontext: string;
  }>;

const C310DashboardCompanyApplicantsTableViewTopnav: React.FC<
  C310DashboardCompanyApplicantsTableViewTopnavProps
> = (props) => {
  return (
    <>
