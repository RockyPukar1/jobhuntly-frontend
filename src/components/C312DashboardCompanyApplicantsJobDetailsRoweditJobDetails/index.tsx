...
type C312DashboardCompanyApplicantsJobDetailsRoweditJobDetailsProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "socialmediaassistant" | "editjobdetails"
> &
  Partial<{ socialmediaassistant: string; editjobdetails: string }>;

const C312DashboardCompanyApplicantsJobDetailsRoweditJobDetails: React.FC<
  C312DashboardCompanyApplicantsJobDetailsRoweditJobDetailsProps
> = (props) => {
  return (
    <>
