...
type C313DashboardCompanyAnalyticsCarddashboardProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "totalviews" | "p23564" | "sixtyfour" | "iconOne" | "vslastday"
> &
  Partial<{
    totalviews: string;
    p23564: string;
...
const C313DashboardCompanyAnalyticsCarddashboard: React.FC<
  C313DashboardCompanyAnalyticsCarddashboardProps
> = (props) => {
  return (
    <>
