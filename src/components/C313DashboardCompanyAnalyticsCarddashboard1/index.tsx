...
type C313DashboardCompanyAnalyticsCarddashboard1Props = Omit<
...
> &
  Partial<{
    ...
    zipcodeOne: string;
    zipcodeTwo: string;
    sevenhundredfifty: string;
    fivehundred: string;
    twohundredfifty: string;
    onehundred: string;
    text2: string;
    text3: string;
    zero: string;
    julcounter: string;
    julcounterOne: string;
    julcounterTwo: string;
    julcounterThree: string;
    julcounterFour: string;
    julcounterFive: string;
    julcounterSix: string;
  }>;

const C313DashboardCompanyAnalyticsCarddashboard1: React.FC<
  C313DashboardCompanyAnalyticsCarddashboard1Props
> = (props) => {
  return (
    <>
