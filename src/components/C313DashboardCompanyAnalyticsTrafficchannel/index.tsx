...
type C313DashboardCompanyAnalyticsTrafficchannelProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  | "trafficchannel"
  | "twohundredfortythreeOne"
  | "directfortyeight"
  | "organictwentyfour"
  | "socialtwentythree"
  | "otherfive"
> &
  Partial<{
    ...
    twohundredfortythreeOne: string;
    directfortyeight: JSX.Element | string;
    organictwentyfour: JSX.Element | string;
    socialtwentythree: JSX.Element | string;
    otherfive: JSX.Element | string;
  }>;

const C313DashboardCompanyAnalyticsTrafficchannel: React.FC<
  C313DashboardCompanyAnalyticsTrafficchannelProps
> = (props) => {
  return (
    <>
