...
type C315DashboardCompanyPostAJobStep2Props = Omit<
...
> &
  Partial<{
    ...
    thisinformationOne: string;
    jobtitle: string;
    timezone: string;
    thisishelpertex: string;
    typeofemploymenOne: string;
    youcanselectmulOne: string;
    captionEight: string;
    captionNine: string;
    captionTen: string;
    ...
    p5000one: string;
    categories: string;
    youcanselectmulThree: string;
    label: string;
    requiredskills: string;
    addrequiredskilOne: string;
    addskills: string;
...
const C315DashboardCompanyPostAJobStep2: React.FC<
  C315DashboardCompanyPostAJobStep2Props
> = (props) => {
  return (
    <>
