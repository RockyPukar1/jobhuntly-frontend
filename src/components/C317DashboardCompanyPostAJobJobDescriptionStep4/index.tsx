...
type C317DashboardCompanyPostAJobJobDescriptionStep4Props = Omit<
...
> &
  Partial<{
    ...
    listoutyourtop: string;
    perksandbenefitOne: string;
    encouragemorepeOne: string;
    addbenefitbutton: string;
    fullhealthcare: string;
    webelieveinthriOne: string;
    fullhealthcare1: string;
    webelieveinthri: string;
    fullhealthcare2: string;
    webelieveinthri1: JSX.Element | string;
    doAReview: string;
  }>;

const C317DashboardCompanyPostAJobJobDescriptionStep4: React.FC<
  C317DashboardCompanyPostAJobJobDescriptionStep4Props
> = (props) => {
  return (
    <>
      <div className={props.className}>
                ...
                <div className="border border-gray-300 border-solid flex flex-1 flex-col gap-6 items-start justify-center p-4 rounded w-full">
                  ...
                  <div className="flex flex-col gap-3 items-start justify-center w-full">
                    <Text
                      ...
                      size="txtClashDisplayVariableSemiBold20"
                    >
                      {props?.fullhealthcare1}
                    </Text>
                    <Text
                      className="leading-[160.00%] max-w-[242px] md:max-w-full text-base text-blue_gray-700"
                      size="txtEpilogueRegular16Bluegray700"
                    >
                      {props?.webelieveinthri}
                    </Text>
                  </div>
                </div>
                <div className="border border-gray-300 border-solid flex flex-1 flex-col gap-6 items-start justify-center p-4 rounded w-full">
                  ...
                  <div className="flex flex-col gap-3 items-start justify-center w-full">
                    <Text
                      ...
                      size="txtClashDisplayVariableSemiBold20"
                    >
                      {props?.fullhealthcare2}
                    </Text>
                    <Text
                      className="leading-[160.00%] max-w-[242px] md:max-w-full text-base text-blue_gray-700"
                      size="txtEpilogueRegular16Bluegray700"
                    >
                      {props?.webelieveinthri1}
                    </Text>
                  </div>
                </div>
              </div>
        ...
        <Button
          className="!text-white-A700 cursor-pointer font-bold font-epilogue min-w-[163px] text-center text-lg"
          shape="square"
          color="indigo_A700"
          size="2xl"
          variant="fill"
...
C317DashboardCompanyPostAJobJobDescriptionStep4.defaultProps = {
  ...
  listoutyourtop: "List out your top perks and benefits.",
  perksandbenefitOne: "Perks and Benefits",
  encouragemorepeOne:
  ...
  fullhealthcare2: "Skill Development",
  webelieveinthri1: (
    <>
