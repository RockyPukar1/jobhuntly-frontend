...
type C318DashboardCompanySettingsOverviewColumnlineTwoProps = Omit<
...
> &
  Partial<{
    basicinformationtext: string;
    companyinformationtext: string;
    companylogotext: string;
    companylogodescriptiontext: string;
    clicktoreplace: JSX.Element | string;
    svgpngjpgor: string;
    companydetails: string;
    introducecompanytext: string;
    label: string;
    labelOne: string;
    labelTwo: string;
    labelThree: string;
...
const C318DashboardCompanySettingsOverviewColumnlineTwo: React.FC<
  C318DashboardCompanySettingsOverviewColumnlineTwoProps
> = (props) => {
  return (
    <>
