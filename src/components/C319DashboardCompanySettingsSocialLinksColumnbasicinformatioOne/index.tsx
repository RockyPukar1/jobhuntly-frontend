...
type C319DashboardCompanySettingsSocialLinksColumnbasicinformatioOneProps =
  Omit<
...
const C319DashboardCompanySettingsSocialLinksColumnbasicinformatioOne: React.FC<
  C319DashboardCompanySettingsSocialLinksColumnbasicinformatioOneProps
> = (props) => {
  return (
    <>
