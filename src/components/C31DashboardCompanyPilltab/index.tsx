...
type C31DashboardCompanyPilltabProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "week" | "month" | "year"
> &
  Partial<{ week: string; month: string; year: string }>;

const C31DashboardCompanyPilltab: React.FC<C31DashboardCompanyPilltabProps> = (
  props,
) => {
  return (
    <>
