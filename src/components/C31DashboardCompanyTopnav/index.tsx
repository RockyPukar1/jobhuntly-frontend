...
type C31DashboardCompanyTopnavProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "companytext" | "postajobbutton"
> &
  Partial<{ companytext: string; postajobbutton: string }>;
...
const C31DashboardCompanyTopnav: React.FC<C31DashboardCompanyTopnavProps> = (
  props,
) => {
  return (
    <>
