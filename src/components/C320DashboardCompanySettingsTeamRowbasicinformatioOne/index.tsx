...
type C320DashboardCompanySettingsTeamRowbasicinformatioOneProps = Omit<
...
> &
  Partial<{
    ...
    addteammemberstext: string;
    memberscountertext: string;
    addmembersbutton: string;
    nametext1: string;
    roletext1: string;
    nametext2: string;
    roletext2: string;
...
const C320DashboardCompanySettingsTeamRowbasicinformatioOne: React.FC<
  C320DashboardCompanySettingsTeamRowbasicinformatioOneProps
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <div className="flex flex-col gap-[23px] items-end justify-end w-auto md:w-full">
          <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between w-[99%] md:w-full">
            ...
            <div className="flex flex-row items-start justify-between w-[39%] sm:w-full">
              <Button
                ...
                variant="fill"
              >
                <div className="!text-white-A700 font-epilogue font-semibold text-base text-center">
                  {props?.addmembersbutton}
                </div>
              </Button>
          ...
          <div className="flex flex-col gap-[23px] items-end justify-start w-full">
            ...
            <Button
              className="!text-white-A700 cursor-pointer font-bold font-epilogue min-w-[209px] text-center text-lg"
              shape="square"
              color="indigo_A700"
              size="2xl"
              variant="fill"
...
C320DashboardCompanySettingsTeamRowbasicinformatioOne.defaultProps = {
  ...
  addteammemberstext: "Add team members of your company",
  memberscountertext: "50 Members",
  addmembersbutton: "Add Members",
  nametext1: "Célestin Gardinier",
  roletext1: "CEO & Co-Founder",
  nametext2: " Reynaud Colbert",
  roletext2: "Co-Founder",
  nametext3: "Arienne Lyon",
  roletext3: "Managing Director",
  nametext4: "Bernard Alexander",
  roletext4: "Managing Director",
  nametext5: "Christine Jhonson",
  roletext5: "Managing Director",
  nametext6: "Aaron Morgan",
  roletext6: "Managing Director",
