...
type C32DashboardCompanyMessagesRowinputProps = Omit<
...
> &
  Partial<{
    ...
    janmayer1: string;
    designercandidaOne: string;
    captionEight: string;
    janmayerOne: string;
    designercandidaThree: string;
    captionNine: string;
    language: string;
    languageOne: string;
    time9: string;
...
const C32DashboardCompanyMessagesRowinput: React.FC<
  C32DashboardCompanyMessagesRowinputProps
> = (props) => {
  return (
    <>
