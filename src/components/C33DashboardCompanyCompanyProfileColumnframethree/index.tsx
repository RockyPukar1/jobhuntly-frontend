...
type C33DashboardCompanyCompanyProfileColumnframethreeProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  | "jobhuntly"
  | "dashboardcaption"
  | "messagescaption"
  | "badgetext"
  | "allapplicantscaption"
  | "joblistingcaption"
  | "myschedulecaption"
  | "settings"
  | "settingscaption"
...
> &
  Partial<{
    ...
    messagescaption: string;
    badgetext: string;
    allapplicantscaption: string;
    joblistingcaption: string;
    myschedulecaption: string;
    settings: string;
    settingscaption: string;
    helpcentercaption: string;
    username: string;
    email: string;
  }>;

const C33DashboardCompanyCompanyProfileColumnframethree: React.FC<
  C33DashboardCompanyCompanyProfileColumnframethreeProps
> = (props) => {
  return (
    <>
