...
type C33DashboardCompanyCompanyProfileJoblistProps = Omit<
...
> &
  Partial<{
    ...
    rectangle2752: string;
    marketingbutton: string;
    designbutton: string;
  }>;

const C33DashboardCompanyCompanyProfileJoblist: React.FC<
  C33DashboardCompanyCompanyProfileJoblistProps
> = (props) => {
  return (
    <>
