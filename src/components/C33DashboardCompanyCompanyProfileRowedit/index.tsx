...
type C33DashboardCompanyCompanyProfileRoweditProps = Omit<
...
> &
  Partial<{
    ...
    industry: string;
    socialnonprofitOne: string;
  }>;

const C33DashboardCompanyCompanyProfileRowedit: React.FC<
  C33DashboardCompanyCompanyProfileRoweditProps
> = (props) => {
  return (
    <>
