...
type C34DashboardCompanyAllApplicantsRowtotalapplicantsOneProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "totalapplicants" | "filterbutton" | "pipelineviewbutton" | "tableviewbutton"
> &
  Partial<{
    totalapplicants: string;
    filterbutton: string;
    pipelineviewbutton: string;
    tableviewbutton: string;
  }>;

const C34DashboardCompanyAllApplicantsRowtotalapplicantsOne: React.FC<
  C34DashboardCompanyAllApplicantsRowtotalapplicantsOneProps
> = (props) => {
  return (
    <>
