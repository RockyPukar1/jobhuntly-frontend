...
type C35DashboardCompanyApplicantProfileColumncaptionNineProps = Omit<
...
> &
  Partial<{
    ...
    genderone: string;
    language1: string;
    englishfrench: string;
    address: string;
    p4517washington: string;
    professionalinfOne: string;
    aboutme: string;
    description: string;
    descriptionone: string;
    currentjob: string;
    productdesignerthree: string;
    highestqualificOne: string;
    bachelorsinengione: string;
    experienceinyeaOne: string;
    durationone: string;
    skillset: string;
...
const C35DashboardCompanyApplicantProfileColumncaptionNine: React.FC<
  C35DashboardCompanyApplicantProfileColumncaptionNineProps
> = (props) => {
  return (
    <>
