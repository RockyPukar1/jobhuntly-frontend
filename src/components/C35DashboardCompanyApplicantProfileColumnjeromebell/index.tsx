...
type C35DashboardCompanyApplicantProfileColumnjeromebellProps = Omit<
...
const C35DashboardCompanyApplicantProfileColumnjeromebell: React.FC<
  C35DashboardCompanyApplicantProfileColumnjeromebellProps
> = (props) => {
  return (
    <>
