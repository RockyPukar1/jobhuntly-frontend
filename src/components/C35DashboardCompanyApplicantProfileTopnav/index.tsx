...
type C35DashboardCompanyApplicantProfileTopnavProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "applicantdetailstext" | "moreactiontext"
> &
  Partial<{ applicantdetailstext: string; moreactiontext: string }>;

const C35DashboardCompanyApplicantProfileTopnav: React.FC<
  C35DashboardCompanyApplicantProfileTopnavProps
> = (props) => {
  return (
    <>
