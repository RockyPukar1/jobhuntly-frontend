...
type C36DashboardCompanyApplicantProfileColumncaptionNineProps = Omit<
...
> &
  Partial<{
    ...
    userexperience: JSX.Element | string;
    usercontactinfo: JSX.Element | string;
  }>;

const C36DashboardCompanyApplicantProfileColumncaptionNine: React.FC<
  C36DashboardCompanyApplicantProfileColumncaptionNineProps
> = (props) => {
  return (
    <>
