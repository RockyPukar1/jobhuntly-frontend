...
type C37DashboardCompanyApplicantProfileColumncaptionNineProps = Omit<
...
> &
  Partial<{
    ...
    shortlisted: string;
    interviewOne: string;
    hireddeclined: string;
    stageinfo: string;
    interviewdate: string;
    p1013july2021: string;
    interviewlocatiOne: string;
    description: JSX.Element | string;
    moveToNextStep: string;
    interviewstatusOne: string;
    onProgress: string;
    assignedto: string;
    notes: string;
    ...
    interviewername1: string;
    interviewdate2: string;
    interviewtime1: string;
    interviewlanguage: string;
  }>;

const C37DashboardCompanyApplicantProfileColumncaptionNine: React.FC<
  C37DashboardCompanyApplicantProfileColumncaptionNineProps
> = (props) => {
  return (
    <>
...
C37DashboardCompanyApplicantProfileColumncaptionNine.defaultProps = {
  ...
  interviewlanguage: "Please, do an interview stage immediately. ",
};
