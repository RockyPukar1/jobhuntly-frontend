...
type C38DashboardCompanyApplicantProfileColumncaptionNineProps = Omit<
...
> &
  Partial<{
    ...
    tomorrow10july: string;
    p11july2021: string;
    p12july2021: string;
    p13july2021: string;
  }>;

const C38DashboardCompanyApplicantProfileColumncaptionNine: React.FC<
  C38DashboardCompanyApplicantProfileColumncaptionNineProps
> = (props) => {
  return (
    <>
