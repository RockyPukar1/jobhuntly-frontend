...
type C39DashboardCompanyJobListingColumnjoblistinglistProps = Omit<
  ...
  | "applicantstext"
  | "needstext"
  | "socialmediaassistanttext"
  | "livebutton"
  | "datetext"
  | "dateonetext"
  | "fulltimebutton"
  | "twohundredthirtyfourtext"
  ...
  | "dateeleventext"
  | "fulltimethreebutton"
  | "twohundredthirtyfourfivetext"
  | "fourhundredelevenfivetext"
  | "kotlindevelopertext1"
  | "closedthreebutton"
  | "datetwelvetext"
  | "datethirteentext"
  | "fulltimefourbutton"
  | "twohundredthirtyfoursixtext"
...
> &
  Partial<{
    ...
    needstext: string;
    socialmediaassistanttext: string;
    livebutton: string;
    datetext: string;
    dateonetext: string;
    fulltimebutton: string;
    twohundredthirtyfourtext: string;
    fourhundredeleventext: JSX.Element | string;
    seniordesignertext: string;
    liveonebutton: string;
    datetwotext: string;
    datethreetext: string;
    fulltimeonebutton: string;
    twohundredthirtyfouronetext: string;
    fourhundredelevenonetext: JSX.Element | string;
    visualdesignertext: string;
    livetwobutton: string;
    datefourtext: string;
    datefivetext: string;
    freelancebutton: string;
    twohundredthirtyfourtwotext: string;
    fourhundredeleventwotext: JSX.Element | string;
    datasciencetext: string;
    closedbutton: string;
    datesixtext: string;
    dateseventext: string;
    freelanceonebutton: string;
    twohundredthirtyfourthreetext: string;
    fourhundredeleventhreetext: JSX.Element | string;
    kotlindevelopertext: string;
    closedonebutton: string;
    dateeighttext: string;
    dateninetext: string;
    fulltimetwobutton: string;
    twohundredthirtyfourfourtext: string;
    fourhundredelevenfourtext: JSX.Element | string;
    reactdevelopertext: string;
    closedtwobutton: string;
    datetentext: string;
    dateeleventext: string;
    fulltimethreebutton: string;
    twohundredthirtyfourfivetext: string;
    fourhundredelevenfivetext: JSX.Element | string;
    kotlindevelopertext1: string;
    closedthreebutton: string;
    datetwelvetext: string;
    datethirteentext: string;
    fulltimefourbutton: string;
    twohundredthirtyfoursixtext: string;
    fourhundredelevensixtext: JSX.Element | string;
    view: string;
    captionEight: string;
    applicantsperpaOne: string;
    one: string;
    oneOne: string;
  }>;
type Table4RowType = {
...
const C39DashboardCompanyJobListingColumnjoblistinglist: React.FC<
  C39DashboardCompanyJobListingColumnjoblistinglistProps
> = (props) => {
