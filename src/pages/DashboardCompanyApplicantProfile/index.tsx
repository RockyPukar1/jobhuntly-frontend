...
import C35DashboardCompanyApplicantProfileColumncaptionNine from "components/C35DashboardCompanyApplicantProfileColumncaptionNine";
...
const DashboardCompanyApplicantProfilePage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay gap-px items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-1 flex-col font-epilogue items-start justify-start md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row font-epilogue gap-8 items-start justify-center sm:px-5 px-8 w-auto md:w-full">
            ...
            <C35DashboardCompanyApplicantProfileColumncaptionNine
              ...
              language={
                <Text className="font-medium text-base text-blue_gray-900 w-auto">
                  ...
                  <span className="text-blue_gray-200 font-epilogue text-left">
                    (26 y.o)
                  </span>
                  <span className="text-blue_gray-900 font-epilogue text-left">
                    {" "}
...
export default DashboardCompanyApplicantProfilePage;
