...
import C37DashboardCompanyApplicantProfileColumncaptionNine from "components/C37DashboardCompanyApplicantProfileColumncaptionNine";
...
const DashboardCompanyApplicantProfile2Page: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay gap-px items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-1 flex-col font-epilogue items-start justify-start md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row font-epilogue gap-8 items-start justify-center sm:px-5 px-8 w-auto md:w-full">
            ...
            <C37DashboardCompanyApplicantProfileColumncaptionNine className="bg-white-A700 flex flex-col gap-6 h-[859px] md:h-auto items-center justify-start outline outline-[1px] outline-gray-300 pb-6 w-auto md:w-full" />
          </div>
        </div>
      </div>
    </>
...
export default DashboardCompanyApplicantProfile2Page;
