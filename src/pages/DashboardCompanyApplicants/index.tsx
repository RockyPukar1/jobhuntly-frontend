...
import C311DashboardCompanyApplicantsRowellipseeightysix from "components/C311DashboardCompanyApplicantsRowellipseeightysix";
...
const DashboardCompanyApplicantsPage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay sm:gap-5 md:gap-5 items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col font-epilogue items-center justify-start mt-[456px] pb-[33px] w-full">
              <MenuItem
                icon={
                  <Img
        ...
        <div className="flex flex-1 flex-col font-epilogue items-center justify-start md:px-5 w-full">
          ...
          <div className="flex flex-col font-clashdisplayvariable items-start justify-start w-auto md:w-full">
            ...
            <C311DashboardCompanyApplicantsRowellipseeightysix className="bg-white-A700 flex md:flex-col flex-row font-epilogue gap-4 items-start justify-start max-w-[1168px] pb-8 sm:px-5 px-8 w-full" />
          </div>
        </div>
      </div>
    </>
...
export default DashboardCompanyApplicantsPage;
