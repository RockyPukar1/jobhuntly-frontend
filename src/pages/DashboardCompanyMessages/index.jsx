...
import C32DashboardCompanyMessagesRowinput from "components/C32DashboardCompanyMessagesRowinput";
...
const DashboardCompanyMessagesPage = () => {
  ...
  const sideBarMenu = [
    ...
    },
    {
      ...
      label: "Messages",
      suffix: (
        <Text className="bg-indigo-A700 flex font-epilogue font-semibold h-6 items-center justify-center mb-[-6px] mt-[-10px] rounded-[50%] text-center text-sm text-white-A700 w-6">
          1
        </Text>
      ),
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay sm:gap-5 md:gap-5 items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col font-epilogue items-center justify-start mt-[395px] pb-[33px] w-full">
              <MenuItem
                icon={
                  <Img
        ...
        <div className="flex flex-1 flex-col items-start justify-start md:px-5 w-full">
          <C31DashboardCompanyTopnav className="bg-white-A700 flex sm:flex-col flex-row font-epilogue md:gap-10 items-center justify-between max-w-[1167px] sm:px-5 px-8 py-4 shadow-bs1 w-full" />
          <Input
            name="title"
            placeholder="Messages"
            className="!placeholder:text-blue_gray-900 !text-blue_gray-900 font-clashdisplayvariable font-semibold md:text-[22px] p-0 sm:text-xl text-2xl text-left w-full"
            wrapClassName="shadow-bs1 w-full"
            shape="square"
            color="white_A700"
            size="3xl"
            variant="fill"
          ></Input>
          <C32DashboardCompanyMessagesRowinput className="bg-white-A700 flex md:flex-col flex-row font-epilogue gap-px items-start justify-start w-auto md:w-full" />
        </div>
      </div>
    </>
  );
...
export default DashboardCompanyMessagesPage;
