...
const DashboardCompanyMessagesPage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay sm:gap-5 md:gap-5 items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-1 flex-col items-start justify-start md:px-5 w-full">
          ...
          <Input
            ...
            className="font-clashdisplayvariable font-semibold md:text-[22px] p-0 placeholder:text-blue_gray-900 sm:text-xl text-2xl text-left w-full"
