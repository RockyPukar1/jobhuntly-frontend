...
import C315DashboardCompanyPostAJobStep2 from "components/C315DashboardCompanyPostAJobStep2";
...
const DashboardCompanyPostAJobPage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay gap-px items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col font-epilogue items-center justify-start mt-[638px] pb-[33px] w-full">
              <MenuItem
                icon={
                  <Img
        ...
        <div className="flex flex-1 flex-col font-epilogue items-center justify-start md:px-5 w-full">
          ...
          <C315DashboardCompanyPostAJobStep2 className="bg-white-A700 flex flex-col font-epilogue gap-6 items-end justify-start p-8 sm:px-5 w-auto md:w-full" />
        </div>
      </div>
    </>
  );
...
export default DashboardCompanyPostAJobPage;
