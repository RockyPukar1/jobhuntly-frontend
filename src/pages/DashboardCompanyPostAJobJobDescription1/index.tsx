...
import C317DashboardCompanyPostAJobJobDescriptionStep4 from "components/C317DashboardCompanyPostAJobJobDescriptionStep4";
...
const DashboardCompanyPostAJobJobDescription1Page: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay gap-px items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col font-epilogue items-center justify-start mt-[430px] pb-[33px] w-full">
              <MenuItem
                icon={
                  <Img
        ...
        <div className="flex flex-1 flex-col font-epilogue items-center justify-start md:px-5 w-full">
          ...
          <C317DashboardCompanyPostAJobJobDescriptionStep4 className="bg-white-A700 flex flex-col font-epilogue gap-6 items-end justify-start p-8 sm:px-5 w-auto md:w-full" />
        </div>
      </div>
    </>
  );
...
export default DashboardCompanyPostAJobJobDescription1Page;
