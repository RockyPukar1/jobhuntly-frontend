...
import C319DashboardCompanySettingsSocialLinksColumnbasicinformatioOne from "components/C319DashboardCompanySettingsSocialLinksColumnbasicinformatioOne";
...
const DashboardCompanySettingsSocialLinksPage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay sm:gap-5 md:gap-5 items-start mx-auto w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col font-epilogue items-center justify-start mt-[269px] pb-[33px] w-full">
              <MenuItem
                icon={
                  <Img
        ...
        <div className="flex flex-1 flex-col font-epilogue items-start justify-start md:px-5 w-full">
          ...
          <div className="flex flex-col font-clashdisplayvariable gap-6 items-start justify-start pt-8 sm:px-5 px-8 w-auto md:w-full">
            <Text
            ...
            <C29DashboardSettingsAccountSettingsTabs
              ...
              logintext="Social Links"
              notificationstext="Team"
            />
          </div>
          <C319DashboardCompanySettingsSocialLinksColumnbasicinformatioOne className="bg-white-A700 flex flex-col font-epilogue gap-6 items-end justify-center p-8 sm:px-5 w-auto md:w-full" />
        </div>
      </div>
    </>
  );
...
export default DashboardCompanySettingsSocialLinksPage;
