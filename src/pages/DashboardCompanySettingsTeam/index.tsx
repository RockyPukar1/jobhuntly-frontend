...
import C320DashboardCompanySettingsTeamRowbasicinformatioOne from "components/C320DashboardCompanySettingsTeamRowbasicinformatioOne";
...
const DashboardCompanySettingsTeamPage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay gap-px items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col font-epilogue items-center justify-start mt-[251px] pb-[33px] w-full">
              <MenuItem
                icon={
                  <Img
        ...
        <div className="flex flex-1 flex-col font-epilogue items-start justify-start md:px-5 w-full">
          ...
          <C320DashboardCompanySettingsTeamRowbasicinformatioOne className="bg-white-A700 flex md:flex-col flex-row font-epilogue gap-[23px] items-start justify-start p-8 sm:px-5 w-auto md:w-full" />
        </div>
      </div>
    </>
  );
...
export default DashboardCompanySettingsTeamPage;
