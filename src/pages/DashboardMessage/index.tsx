...
import C22DashboardMessageRowinput from "components/C22DashboardMessageRowinput";
...
const DashboardMessagePage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay sm:gap-5 md:gap-5 items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col font-epilogue items-center justify-start mt-[353px] pb-[33px] w-full">
              <MenuItem
                icon={
                  <Img
        ...
        <div className="flex flex-1 flex-col font-clashdisplayvariable items-start justify-start md:px-5 w-full">
          <C21DashboardApplicantTopnav
            ...
            dashboardtext="Messages"
          />
          <C22DashboardMessageRowinput
            className="bg-white-A700 flex md:flex-col flex-row font-epilogue gap-px items-start justify-start w-auto md:w-full"
            thisisthevery={
              <Text className="font-medium text-base text-blue_gray-900 w-auto">
