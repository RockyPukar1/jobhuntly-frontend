...
import C211DashboardSettingsNotificationsColumnlineTwo from "components/C211DashboardSettingsNotificationsColumnlineTwo";
...
const DashboardSettingsNotificationsPage: React.FC = () => {
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-redhatdisplay gap-px items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-1 flex-col font-clashdisplayvariable items-start justify-start md:px-5 w-full">
          ...
          <div className="flex flex-col font-epilogue h-[902px] md:h-auto items-start justify-start max-w-[1168px] w-full">
            ...
            <C211DashboardSettingsNotificationsColumnlineTwo className="bg-white-A700 flex flex-col gap-6 items-end justify-start pb-8 pt-6 sm:px-5 px-8 w-full" />
          </div>
        </div>
      </div>
    </>
